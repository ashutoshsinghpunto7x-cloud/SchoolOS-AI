...
const notificationSchema = new Schema<INotification>(
  {
    ...
    type:            { type: String, enum: ['defaulters_list', 'message', 'change_request', 'leave_request', 'substitution', 'planner_reminder', 'maintenance_scheduled', 'maintenance_toggled'], required: true },
