...
export const ROLE_PERMISSIONS: Record<UserRole, readonly Permission[]> = {
  ...
  // Mirrors principal 1:1 for now — see UserRole definition.
  incharge: Object.values(PERMISSIONS) as Permission[],
  reception: [
    'students.view',
    'students.create',
    'students.update',
...
export const ROLE_META: Record<UserRole, { label: string; description: string }> = {
  ...
  incharge: { label: 'Incharge', description: 'School oversight — timetable, attendance, leave approvals, and staff' },
