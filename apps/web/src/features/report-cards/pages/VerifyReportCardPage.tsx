...
import { useVerifyReportCard } from '../hooks/useReportCard';
...
export function VerifyReportCardPage() {
  ...
  const { data, isLoading, isError } = useVerifyReportCard(token);
          ...
          <>
            ...
            <div className="mt-6 divide-y divide-gray-100 border-y border-gray-100 text-left">
              <div className="flex items-center justify-between py-2.5">
                ...
                <span className="text-xs font-semibold text-gray-900">{data.examName}</span>
              </div>
              {data.overallGrade && (
                <div className="flex items-center justify-between py-2.5">
