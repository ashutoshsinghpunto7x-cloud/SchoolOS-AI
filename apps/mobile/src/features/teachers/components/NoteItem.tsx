...
import type { TeacherNote } from '@schoolos/types';
import { Card } from '@/components/Card';
import { StatusPill } from '@/components/StatusPill';
import { useTheme } from '@/theme';

const TYPE_LABEL: Record<TeacherNote['type'], string> = {
  general: 'General',
  pinned: 'Pinned',
  private: 'Private',
};

const TYPE_TONE: Record<TeacherNote['type'], 'neutral' | 'warning' | 'danger'> = {
  general: 'neutral',
  pinned: 'warning',
  private: 'danger',
};

export function NoteItem({ note, onDelete }: { note: TeacherNote; onDelete?: () => void }) {
