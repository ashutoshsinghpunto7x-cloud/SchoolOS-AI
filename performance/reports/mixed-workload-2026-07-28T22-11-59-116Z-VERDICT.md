...
Generated: 2026-07-28T22:11:59.116Z
...
|---|---|
| Total Requests | 634 |
| Successful Requests | 614 |
| Failed Requests | 20 |
| Average Response (ms) | 705.1 |
| P95 (ms) | 2145.4 |
| P99 (ms) | 2305.3 |
| Maximum Response (ms) | 2348.6 |
| Requests/sec | 93.63 |
| 429 Count | 0 |
| 500 Count | 0 |
...
| Per-teacher workflow success rate | 63.33% |
...
2. `http_req_failed` failed `rate<0.01`
3. `login_duration` failed `p(95)<1000`
