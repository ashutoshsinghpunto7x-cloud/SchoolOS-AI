...
Generated: 2026-07-28T20:11:54.585Z
...
| Failed Requests | 0 |
| Average Response (ms) | 763.8 |
| P95 (ms) | 2075.2 |
| P99 (ms) | 2318.9 |
| Maximum Response (ms) | 2418.1 |
| Requests/sec | 101.79 |
| 429 Count | 0 |
| 500 Count | 0 |
...
2. `http_req_duration` failed `p(99)<1000`
...
7. `http_req_duration{name:GET /teacher-workspace/me}` failed `p(95)<500`
8. `http_req_duration{name:GET /students (roster)}` failed `p(95)<500`
